...
export default scene => {    
    ...
    const lightAmbient = new THREE.HemisphereLight( 0xffffff, 0x444444 );
    lightAmbient.position.set( 0, 4000, 0 );
...
*/    
    // direct light
    lightDirect.position.set( 3000, 3000, -3000 );
    lightDirect.castShadow = true;
    lightDirect.lightProbeIntensity=2.0;
    lightDirect.directionalLightIntensity=0.8;
