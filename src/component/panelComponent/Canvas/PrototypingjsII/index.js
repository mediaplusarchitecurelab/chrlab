        ...
        return (
            <div id="panel-canvas" className="panel-canvas" ref={element => this.threeRootElement = element}>    	
                ...
                <div style={{position:'absolute', margin:'20px 20px 20px 20px'}}>
                    ...
                    <div as='h6' id="infoProgress" style={{color:'white',  fontFamily: 'Titillium Web', textShadow: '5px 5px 1px #333333, 2px 2px 1px #333333'}}></div>
                    <div as='h6' id="infoAll" style={{color:'white', fontFamily: 'Titillium Web', textShadow: '5px 5px 1px #333333, 2px 2px 1px #333333'}}>GoeAllNum:</div>  
                </div>
            </div>
        );
    }
